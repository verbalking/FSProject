...
import com.LaadidaouiZahir.spring.data.mongodb.repository.ProductRepository;
...
public class ProductController {
  ...
  public ResponseEntity<Product> createProduct(@RequestBody Product product) {
    try {
      Product _product = productRepository.save(new Product(product.getName(), product.getPrice(), false));
